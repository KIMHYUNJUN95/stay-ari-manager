...
const DesktopMenuDrawer = ({ open, onClose, onNavigate, onSync, syncing, onLogout, currentPath, userData }) => {
  const desktopDrawerItems = [
    ...MENU_ITEMS,
    ...MORE_MENU_ITEMS.filter((item) => item.path === '/price-history' && !MENU_ITEMS.some((menuItem) => menuItem.path === item.path)),
  ];
  const groupedMenuItems = [
    { label: 'Menu', items: desktopDrawerItems.slice(0, 10) },
    { label: 'Tools', items: desktopDrawerItems.slice(10) },
  ];
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span style={{ fontSize: '16px', fontWeight: '700', color: '#14284B', letterSpacing: '-0.3px' }}>Haru Studio</span>
              <span style={{ fontSize: '11px', fontWeight: '500', color: '#64748B' }}>Property Management System</span>
            </div>
          </div>
        ...
        <div style={{ padding: '0 20px 18px' }}>
          <button
            ...
            style={{
              width: '100%',
              padding: '13px 16px',
              background: syncing ? '#94A3B8' : '#1F2937',
              color: '#FFFFFF',
              border: 'none',
              borderRadius: '14px',
              fontSize: '14px',
              ...
              justifyContent: 'center',
              gap: '8px',
              boxShadow: syncing ? 'none' : '0 10px 24px rgba(31, 41, 55, 0.18)',
            }}
          >
                  ...
                  return (
                    ...
                    >
                      <div style={{
                        ...
                        height: '34px',
                        borderRadius: '10px',
                        background: isActive ? 'rgba(255,255,255,0.14)' : '#F8FAFC',
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                        flexShrink: 0,
                      }}>
                        <MenuIcon name={item.icon} active={isActive} size={18} />
                      </div>
                      <span style={{
                        fontSize: '14px',
        ...
        {!isMobile && (
          <header style={styles.header}>
            <div style={styles.headerLeft}>
              ...
              >
                <span style={styles.desktopMenuIcon}>
                  <span style={styles.desktopMenuIconLine} />
                  <span style={styles.desktopMenuIconLine} />
                  <span style={styles.desktopMenuIconLine} />
                </span>
...
const styles = {
  ...
  headerSearchWrap: { position: 'relative', flex: 1, maxWidth: '420px' },
  headerSearch: {
