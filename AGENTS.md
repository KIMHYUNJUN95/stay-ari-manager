# Stay-Ari Manager — Codex 작업 지침

## 작업 전 필수 메뉴얼
- 모든 작업 시작 전 `docs/rules/CODEX_WORK_MANUAL.md`를 먼저 확인하고 적용할 것
- 기존 원본 수정, 삭제, 빌드, 배포, GitHub 푸시는 위 메뉴얼의 승인 절차를 우선 적용할 것
...
- 사용자의 의견이나 방향이 비합리적이거나 더 나은 대안이 있을 경우, 이를 숨기지 말고 현실적이고 직접적으로 피드백할 것
- 사용자의 판단이 합리적이면 명확히 동의하되, 불필요한 맞장구나 형식적인 동의는 하지 말 것
